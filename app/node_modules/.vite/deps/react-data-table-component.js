...
function f2(e2, t2) {
  ...
  switch (t2.type) {
    case "SELECT_ALL_ROWS": {
      ...
      if (l3) {
        const t3 = r3 ? [...e2.selectedRows, ...o2.filter((t4) => !m2(t4, e2.selectedRows, n2))] : e2.selectedRows.filter((e3) => !m2(e3, o2, n2));
    ...
    case "SELECT_MULTIPLE_ROWS": {
      ...
      if (r3) {
        const t3 = [...e2.selectedRows, ...a2.filter((t4) => !m2(t4, e2.selectedRows, o2))];
...
`;
var H2 = ut(P2).attrs((e2) => ({ style: e2.style }))`
	${({ $renderAsCell: e2 }) => !e2 && D2};
	${({ theme: e2, $isDragging: t2 }) => t2 && e2.cells.draggingStyle};
	${({ $cellStyle: e2 }) => e2};
`;
var F2 = e.memo(function({ id: t2, column: n, row: o2, rowIndex: a2, dataTag: l3, isDragging: r3, onDragStart: s3, onDragOver: d2, onDragEnd: c3, onDragEnter: g3, onDragLeave: u3 }) {
  const { style: p3, classNames: m3 } = b(o2, n.conditionalCellStyles, ["rdt_TableCell"]);
  return e.createElement(H2, { id: t2, "data-column-id": n.id, role: "cell", className: m3, "data-tag": l3, $cellStyle: n.style, $renderAsCell: !!n.cell, $allowOverflow: n.allowOverflow, button: n.button, center: n.center, compact: n.compact, grow: n.grow, hide: n.hide, maxWidth: n.maxWidth, minWidth: n.minWidth, right: n.right, width: n.width, $wrapCell: n.wrap, style: p3, $isDragging: r3, onDragStart: s3, onDragOver: d2, onDragEnd: c3, onDragEnter: g3, onDragLeave: u3 }, !n.cell && e.createElement("div", { "data-tag": l3 }, function(e2, t3, n2, o3) {
    if (!t3)
      return null;
...
function q2({ columns: t2 = [], conditionalRowStyles: n = [], defaultExpanded: o2 = false, defaultExpanderDisabled: a2 = false, dense: l3 = false, expandableIcon: i3, expandableRows: s3 = false, expandableRowsComponent: d2, expandableRowsComponentProps: c3, expandableRowsHideExpander: g3, expandOnRowClicked: u3 = false, expandOnRowDoubleClicked: m3 = false, highlightOnHover: h2 = false, id: f3, expandableInheritConditionalStyles: x3, keyField: C3, onRowClicked: y3 = p2, onRowDoubleClicked: R3 = p2, onRowMouseEnter: v3 = p2, onRowMouseLeave: S3 = p2, onRowExpandToggled: E3 = p2, onSelectedRow: O3 = p2, pointerOnHover: $3 = false, row: k3, rowCount: P3, rowIndex: D3, selectableRowDisabled: H3 = null, selectableRows: j3 = false, selectableRowsComponent: I3, selectableRowsComponentProps: L3, selectableRowsHighlight: M3 = false, selectableRowsSingle: A3 = false, selected: N3, striped: W3 = false, draggingColumnId: B3, onDragStart: G3, onDragOver: V3, onDragEnd: U3, onDragEnter: Y3, onDragLeave: q3 }) {
  ...
  const X3 = e.useCallback(() => {
    Q3(!J3), E3(!J3, k3);
  }, [J3, E3, k3]), Z3 = $3 || s3 && (u3 || m3), ee3 = e.useCallback((e2) => {
    e2.target && "allowRowEvents" === e2.target.getAttribute("data-tag") && (y3(k3, e2), !a2 && s3 && u3 && X3());
  }, [a2, u3, s3, X3, y3, k3]), te3 = e.useCallback((e2) => {
    e2.target && "allowRowEvents" === e2.target.getAttribute("data-tag") && (R3(k3, e2), !a2 && s3 && m3 && X3());
  }, [a2, m3, s3, X3, R3, k3]), ne3 = e.useCallback((e2) => {
    v3(k3, e2);
  }, [v3, k3]), oe3 = e.useCallback((e2) => {
    S3(k3, e2);
  }, [S3, k3]), ae3 = r2(k3, C3), { style: le3, classNames: re3 } = b(k3, n, ["rdt_TableRow"]), ie3 = M3 && N3, se3 = x3 ? le3 : {}, de3 = W3 && D3 % 2 == 0;
  return e.createElement(e.Fragment, null, e.createElement(K2, { id: `row-${f3}`, role: "row", $striped: de3, $highlightOnHover: h2, $pointerOnHover: !a2 && Z3, $dense: l3, onClick: ee3, onDoubleClick: te3, onMouseEnter: ne3, onMouseLeave: oe3, className: re3, $selected: ie3, style: le3 }, j3 && e.createElement(T2, { name: `select-row-${ae3}`, keyField: C3, row: k3, rowCount: P3, selected: N3, selectableRowsComponent: I3, selectableRowsComponentProps: L3, selectableRowDisabled: H3, selectableRowsSingle: A3, onSelectedRow: O3 }), s3 && !g3 && e.createElement(_2, { id: ae3, expandableIcon: i3, expanded: J3, row: k3, onToggled: X3, disabled: a2 }), t2.map((t3) => t3.omit ? null : e.createElement(F2, { id: `cell-${t3.id}-${ae3}`, key: `cell-${t3.id}-${ae3}`, dataTag: t3.ignoreRowClick || t3.button ? null : "allowRowEvents", column: t3, row: k3, rowIndex: D3, isDragging: w2(B3, t3.id), onDragStart: G3, onDragOver: V3, onDragEnd: U3, onDragEnter: Y3, onDragLeave: q3 }))), s3 && J3 && e.createElement(z2, { key: `expander-${ae3}`, data: k3, extendedRowStyle: se3, extendedClassNames: re3, ExpanderComponent: d2, expanderComponentProps: c3 }));
}
var J2 = ut.span`
	padding: 2px;
	color: inherit;
...
var te2 = ut.div`
	...
	text-overflow: ellipsis;
`;
var ne2 = e.memo(function({ column: t2, disabled: n, draggingColumnId: o2, selectedColumn: a2 = {}, sortDirection: r3, sortIcon: i3, sortServer: s3, pagination: d2, paginationServer: c3, persistSelectedOnSort: g3, selectableRowsVisibleOnly: u3, onSort: p3, onDragStart: b2, onDragOver: m3, onDragEnd: h2, onDragEnter: f3, onDragLeave: x3 }) {
  e.useEffect(() => {
  ...
  const v3 = () => {
    if (!t2.sortable && !t2.selector)
      return;
    let e2 = r3;
    w2(a2.id, t2.id) && (e2 = r3 === l2.ASC ? l2.DESC : l2.ASC), p3({ type: "SORT_CHANGE", sortDirection: e2, selectedColumn: t2, clearSelectedOnSort: d2 && c3 && !g3 || s3 || u3 });
...
var Le2 = e.memo(function({ rowsPerPage: t2, rowCount: n, currentPage: o2, direction: a2 = ke2.direction, paginationRowsPerPageOptions: l3 = ke2.paginationRowsPerPageOptions, paginationIconLastPage: r3 = ke2.paginationIconLastPage, paginationIconFirstPage: i3 = ke2.paginationIconFirstPage, paginationIconNext: s3 = ke2.paginationIconNext, paginationIconPrevious: d2 = ke2.paginationIconPrevious, paginationComponentOptions: c3 = ke2.paginationComponentOptions, onChangeRowsPerPage: u3 = ke2.onChangeRowsPerPage, onChangePage: p3 = ke2.onChangePage }) {
  ...
  })(), m3 = le2(a2), h2 = b2.width && b2.width > 599, w3 = g2(n, t2), f3 = o2 * t2, x3 = f3 - t2 + 1, C3 = 1 === o2, y3 = o2 === w3, R3 = Object.assign(Object.assign({}, Pe2), c3), v3 = o2 === w3 ? `${x3}-${n} ${R3.rangeSeparatorText} ${n}` : `${x3}-${f3} ${R3.rangeSeparatorText} ${n}`, S3 = e.useCallback(() => p3(o2 - 1), [o2, p3]), E3 = e.useCallback(() => p3(o2 + 1), [o2, p3]), O3 = e.useCallback(() => p3(1), [p3]), $3 = e.useCallback(() => p3(g2(n, t2)), [p3, n, t2]), k3 = e.useCallback((e2) => u3(Number(e2.target.value), o2), [o2, u3]), P3 = l3.map((t3) => e.createElement("option", { key: t3, value: t3 }, t3));
...
function Je2(t2, n, o2, a2) {
  const [r3, i3] = e.useState(() => c2(t2)), [s3, d2] = e.useState(""), g3 = e.useRef("");
  Me2(() => {
    i3(c2(t2));
  }, [t2]);
  const u3 = e.useCallback((e2) => {
    ...
    l3 && (g3.current = (null === (o3 = null === (n2 = r3[h(r3, l3)]) || void 0 === n2 ? void 0 : n2.id) || void 0 === o3 ? void 0 : o3.toString()) || "", d2(g3.current));
    ...
    if (a3 && g3.current && a3 !== g3.current) {
      const e3 = h(r3, g3.current), t4 = h(r3, a3), o4 = [...r3];
...
var Qe2 = e.memo(function(t2) {
  const { data: n = ke2.data, columns: o2 = ke2.columns, title: s3 = ke2.title, actions: d2 = ke2.actions, keyField: c3 = ke2.keyField, striped: p3 = ke2.striped, highlightOnHover: b2 = ke2.highlightOnHover, pointerOnHover: h2 = ke2.pointerOnHover, dense: w3 = ke2.dense, selectableRows: x3 = ke2.selectableRows, selectableRowsSingle: y3 = ke2.selectableRowsSingle, selectableRowsHighlight: S3 = ke2.selectableRowsHighlight, selectableRowsNoSelectAll: E3 = ke2.selectableRowsNoSelectAll, selectableRowsVisibleOnly: O3 = ke2.selectableRowsVisibleOnly, selectableRowSelected: $3 = ke2.selectableRowSelected, selectableRowDisabled: P3 = ke2.selectableRowDisabled, selectableRowsComponent: D3 = ke2.selectableRowsComponent, selectableRowsComponentProps: H3 = ke2.selectableRowsComponentProps, onRowExpandToggled: F3 = ke2.onRowExpandToggled, onSelectedRowsChange: j3 = ke2.onSelectedRowsChange, expandableIcon: I3 = ke2.expandableIcon, onChangeRowsPerPage: T3 = ke2.onChangeRowsPerPage, onChangePage: L3 = ke2.onChangePage, paginationServer: M3 = ke2.paginationServer, paginationServerOptions: A3 = ke2.paginationServerOptions, paginationTotalRows: _3 = ke2.paginationTotalRows, paginationDefaultPage: N3 = ke2.paginationDefaultPage, paginationResetDefaultPage: z3 = ke2.paginationResetDefaultPage, paginationPerPage: W3 = ke2.paginationPerPage, paginationRowsPerPageOptions: B3 = ke2.paginationRowsPerPageOptions, paginationIconLastPage: G3 = ke2.paginationIconLastPage, paginationIconFirstPage: V3 = ke2.paginationIconFirstPage, paginationIconNext: U3 = ke2.paginationIconNext, paginationIconPrevious: Y3 = ke2.paginationIconPrevious, paginationComponent: K3 = ke2.paginationComponent, paginationComponentOptions: J3 = ke2.paginationComponentOptions, responsive: Q3 = ke2.responsive, progressPending: X3 = ke2.progressPending, progressComponent: Z3 = ke2.progressComponent, persistTableHead: ee3 = ke2.persistTableHead, noDataComponent: te3 = ke2.noDataComponent, disabled: oe3 = ke2.disabled, noTableHead: le3 = ke2.noTableHead, noHeader: re3 = ke2.noHeader, fixedHeader: ie3 = ke2.fixedHeader, fixedHeaderScrollHeight: se3 = ke2.fixedHeaderScrollHeight, pagination: de3 = ke2.pagination, subHeader: ce3 = ke2.subHeader, subHeaderAlign: ge3 = ke2.subHeaderAlign, subHeaderWrap: ue3 = ke2.subHeaderWrap, subHeaderComponent: be3 = ke2.subHeaderComponent, noContextMenu: me3 = ke2.noContextMenu, contextMessage: he3 = ke2.contextMessage, contextActions: Se3 = ke2.contextActions, contextComponent: Ee3 = ke2.contextComponent, expandableRows: Oe3 = ke2.expandableRows, onRowClicked: $e3 = ke2.onRowClicked, onRowDoubleClicked: Pe3 = ke2.onRowDoubleClicked, onRowMouseEnter: De3 = ke2.onRowMouseEnter, onRowMouseLeave: He3 = ke2.onRowMouseLeave, sortIcon: Fe3 = ke2.sortIcon, onSort: je3 = ke2.onSort, sortFunction: Ie3 = ke2.sortFunction, sortServer: Te3 = ke2.sortServer, expandableRowsComponent: Ae3 = ke2.expandableRowsComponent, expandableRowsComponentProps: _e3 = ke2.expandableRowsComponentProps, expandableRowDisabled: Ne3 = ke2.expandableRowDisabled, expandableRowsHideExpander: ze3 = ke2.expandableRowsHideExpander, expandOnRowClicked: We3 = ke2.expandOnRowClicked, expandOnRowDoubleClicked: Be3 = ke2.expandOnRowDoubleClicked, expandableRowExpanded: Ge3 = ke2.expandableRowExpanded, expandableInheritConditionalStyles: Ve3 = ke2.expandableInheritConditionalStyles, defaultSortFieldId: Ye3 = ke2.defaultSortFieldId, defaultSortAsc: qe3 = ke2.defaultSortAsc, clearSelectedRows: Qe3 = ke2.clearSelectedRows, conditionalRowStyles: Xe2 = ke2.conditionalRowStyles, theme: Ze2 = ke2.theme, customStyles: et = ke2.customStyles, direction: tt2 = ke2.direction, onColumnOrderChange: nt2 = ke2.onColumnOrderChange, className: ot2 } = t2, { tableColumns: at2, draggingColumnId: lt2, handleDragStart: rt2, handleDragEnter: it2, handleDragOver: st2, handleDragLeave: dt, handleDragEnd: ct2, defaultSortDirection: gt, defaultSortColumn: ut2 } = Je2(o2, nt2, Ye3, qe3), [{ rowsPerPage: pt2, currentPage: bt, selectedRows: mt2, allSelected: ht, selectedCount: wt, selectedColumn: ft, sortDirection: xt, toggleOnSelectedRowsChange: Ct }, yt] = e.useReducer(f2, { allSelected: false, selectedCount: 0, selectedRows: [], selectedColumn: ut2, toggleOnSelectedRowsChange: false, sortDirection: gt, currentPage: N3, rowsPerPage: W3, selectedRowsFlag: false, contextMessage: ke2.contextMessage }), { persistSelectedOnSort: Rt = false, persistSelectedOnPageChange: vt2 = false } = A3, St = !(!M3 || !vt2 && !Rt), Et = de3 && !X3 && n.length > 0, Ot = K3 || Le2, $t = e.useMemo(() => ((e2 = {}, t3 = "default", n2 = "default") => {
    ...
    var a2;
  })(et, Ze2), [et, Ze2]), kt = e.useMemo(() => Object.assign({}, "auto" !== tt2 && { dir: tt2 }), [tt2]), Pt = e.useMemo(() => {
    if (Te3)
      return n;
    ...
    return Pt;
  }, [bt, de3, M3, pt2, Pt]), Ht = e.useCallback((e2) => {
    yt(e2);
  }, []), Ft = e.useCallback((e2) => {
    yt(e2);
  }, []), jt = e.useCallback((e2) => {
    yt(e2);
  }, []), It = e.useCallback((e2, t3) => $e3(e2, t3), [$e3]), Tt = e.useCallback((e2, t3) => Pe3(e2, t3), [Pe3]), Lt = e.useCallback((e2, t3) => De3(e2, t3), [De3]), Mt = e.useCallback((e2, t3) => He3(e2, t3), [He3]), At = e.useCallback((e2) => yt({ type: "CHANGE_PAGE", page: e2, paginationServer: M3, visibleOnly: O3, persistSelectedOnPageChange: vt2 }), [M3, vt2, O3]), _t = e.useCallback((e2) => {
    const t3 = g2(_3 || Dt.length, e2), n2 = u2(bt, t3);
    M3 || At(n2), yt({ type: "CHANGE_ROWS_PER_PAGE", page: n2, rowsPerPage: e2 });
  }, [bt, At, M3, _3, Dt.length]);
  if (de3 && !M3 && Pt.length > 0 && 0 === Dt.length) {
    const e2 = g2(Pt.length, pt2), t3 = u2(bt, e2);
    At(t3);
  }
  Me2(() => {
    j3({ allSelected: ht, selectedCount: wt, selectedRows: mt2.slice(0) });
  }, [Ct]), Me2(() => {
    ...
    if (de3 && M3 && _3 > 0) {
      const e2 = g2(_3, pt2), t3 = u2(bt, e2);
      bt !== t3 && At(t3);
    }
  }, [_3]), e.useEffect(() => {
  ...
  const Nt = O3 ? Dt : Pt, zt = vt2 || y3 || E3;
  return e.createElement(tt, { theme: $t }, !re3 && (!!s3 || !!d2) && e.createElement(pe2, { title: s3, actions: d2, showMenu: !me3, selectedCount: wt, direction: tt2, contextActions: Se3, contextComponent: Ee3, contextMessage: he3 }), ce3 && e.createElement(we2, { align: ge3, wrapContent: ue3 }, be3), e.createElement(xe2, Object.assign({ $responsive: Q3, $fixedHeader: ie3, $fixedHeaderScrollHeight: se3, className: ot2 }, kt), e.createElement(ye2, null, X3 && !ee3 && e.createElement(Ce2, null, Z3), e.createElement(C2, { disabled: oe3, className: "rdt_Table", role: "table" }, !le3 && (!!ee3 || Pt.length > 0 && !X3) && e.createElement(R2, { className: "rdt_TableHead", role: "rowgroup", $fixedHeader: ie3 }, e.createElement(v2, { className: "rdt_TableHeadRow", role: "row", $dense: w3 }, x3 && (zt ? e.createElement(k2, { style: { flex: "0 0 48px" } }) : e.createElement(ae2, { allSelected: ht, selectedRows: mt2, selectableRowsComponent: D3, selectableRowsComponentProps: H3, selectableRowDisabled: P3, rowData: Nt, keyField: c3, mergeSelections: St, onSelectAllRows: Ft })), Oe3 && !ze3 && e.createElement(Re2, null), at2.map((t3) => e.createElement(ne2, { key: t3.id, column: t3, selectedColumn: ft, disabled: X3 || 0 === Pt.length, pagination: de3, paginationServer: M3, persistSelectedOnSort: Rt, selectableRowsVisibleOnly: O3, sortDirection: xt, sortIcon: Fe3, sortServer: Te3, onSort: Ht, onDragStart: rt2, onDragOver: st2, onDragEnd: ct2, onDragEnter: it2, onDragLeave: dt, draggingColumnId: lt2 })))), !Pt.length && !X3 && e.createElement(ve2, null, te3), X3 && ee3 && e.createElement(Ce2, null, Z3), !X3 && Pt.length > 0 && e.createElement(fe2, { className: "rdt_TableBody", role: "rowgroup" }, Dt.map((t3, n2) => {
    const o3 = r2(t3, c3), a2 = function(e2 = "") {
      return "number" != typeof e2 && (!e2 || 0 === e2.length);
    }(o3) ? n2 : o3, l3 = m2(t3, mt2, c3), i3 = !!(Oe3 && Ge3 && Ge3(t3)), s4 = !!(Oe3 && Ne3 && Ne3(t3));
    return e.createElement(q2, { id: a2, key: a2, keyField: c3, "data-row-id": a2, columns: at2, row: t3, rowCount: Pt.length, rowIndex: n2, selectableRows: x3, expandableRows: Oe3, expandableIcon: I3, highlightOnHover: b2, pointerOnHover: h2, dense: w3, expandOnRowClicked: We3, expandOnRowDoubleClicked: Be3, expandableRowsComponent: Ae3, expandableRowsComponentProps: _e3, expandableRowsHideExpander: ze3, defaultExpanderDisabled: s4, defaultExpanded: i3, expandableInheritConditionalStyles: Ve3, conditionalRowStyles: Xe2, selected: l3, selectableRowsHighlight: S3, selectableRowsComponent: D3, selectableRowsComponentProps: H3, selectableRowDisabled: P3, selectableRowsSingle: y3, striped: p3, onRowExpandToggled: F3, onRowClicked: It, onRowDoubleClicked: Tt, onRowMouseEnter: Lt, onRowMouseLeave: Mt, onSelectedRow: jt, draggingColumnId: lt2, onDragStart: rt2, onDragOver: st2, onDragEnd: ct2, onDragEnter: it2, onDragLeave: dt });
  }))))), Et && e.createElement("div", null, e.createElement(Ot, { onChangePage: At, onChangeRowsPerPage: _t, rowCount: _3 || Pt.length, currentPage: bt, rowsPerPage: pt2, direction: tt2, paginationRowsPerPageOptions: B3, paginationIconLastPage: G3, paginationIconFirstPage: V3, paginationIconNext: U3, paginationIconPrevious: Y3, paginationComponentOptions: J3 })));
});
export {
  G2 as Alignment,
  B2 as Direction,
